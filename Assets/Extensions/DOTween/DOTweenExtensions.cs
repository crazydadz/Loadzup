...
namespace Silphid.Extensions
{
    public static class DOTweenExtensions
    {
        ...
        {
            return DOTween.ToAlpha(() => This.color, x => This.color = x, endValue, duration).SetUpdate(UpdateType.Normal, true);
        }
        ...
        public static Tween DOFadeOutAndHide(this Graphic This, float duration)
        {
            ...
            return DOTween.ToAlpha(() => This.color, x => This.color = x, 0, duration).OnComplete(() => This.enabled = false).SetTimeScaleIndependent();
        }
        ...
        public static TweenerCore<float, float, FloatOptions> DOFadeTo(this CanvasGroup This, float target, float duration)
        {
        ...
        public static Tweener DOFade(this Renderer This, float endValue, float duration)
        {
            ...
            return DOTween.ToAlpha(() => spriteRenderer.color, x => spriteRenderer.color = x, endValue, duration).SetUpdate(UpdateType.Normal, true);
        }
        ...
        public static Tween DOFadeOut(this Renderer This, float duration)
        {
            ...
            return DOTween.ToAlpha(() => spriteRenderer.color, x => spriteRenderer.color = x, 0, duration).OnComplete(() =>
            {
        ...
        public static Tween DOShowAndFadeIn(this Renderer This, float duration)
        {
            ...
            return DOTween.ToAlpha(() => spriteRenderer.color, x => spriteRenderer.color = x, 1, duration).SetTimeScaleIndependent();
        }
